...
The supported root launchers are `Launch-NeuralDoom.cmd` and `Launch-NeuralDoom-RTX.cmd`. They select a manifest-verified build and preserve the playtest save folder.
