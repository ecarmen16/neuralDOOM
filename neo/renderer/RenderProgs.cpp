...
#define usePushConstants( layoutType ) ( layoutTypeAttributes[layoutType].pcEnabled ? "1" : "0" )
	...
	} builtins[] =
	{
		...
		{ BUILTIN_AMBIENT_LIGHTING_IBL, "builtin/lighting/ambient_lighting_IBL", "", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "0" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTING_IBL_RT_CAPTURE, "builtin/lighting/ambient_lighting_IBL", "_RT_capture", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "1" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTING_IBL_SKINNED, "builtin/lighting/ambient_lighting_IBL", "_skinned", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "0" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },
		{ BUILTIN_AMBIENT_LIGHTING_IBL_SKINNED_RT_CAPTURE, "builtin/lighting/ambient_lighting_IBL", "_skinned_RT_capture", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "1" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },
		{ BUILTIN_AMBIENT_LIGHTING_IBL_PBR, "builtin/lighting/ambient_lighting_IBL", "_PBR", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "0" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTING_IBL_PBR_RT_CAPTURE, "builtin/lighting/ambient_lighting_IBL", "_PBR_RT_capture", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "1" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTING_IBL_PBR_SKINNED, "builtin/lighting/ambient_lighting_IBL", "_PBR_skinned", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "0" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },
		{ BUILTIN_AMBIENT_LIGHTING_IBL_PBR_SKINNED_RT_CAPTURE, "builtin/lighting/ambient_lighting_IBL", "_PBR_skinned_RT_capture", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "1" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },

		{ BUILTIN_AMBIENT_LIGHTGRID_IBL, "builtin/lighting/ambient_lightgrid_IBL", "", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "0" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTGRID_IBL_RT_CAPTURE, "builtin/lighting/ambient_lightgrid_IBL", "_RT_capture", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "1" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTGRID_IBL_SKINNED, "builtin/lighting/ambient_lightgrid_IBL", "_skinned", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "0" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },
		{ BUILTIN_AMBIENT_LIGHTGRID_IBL_SKINNED_RT_CAPTURE, "builtin/lighting/ambient_lightgrid_IBL", "_skinned_RT_capture", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "0" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "1" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },
		{ BUILTIN_AMBIENT_LIGHTGRID_IBL_PBR, "builtin/lighting/ambient_lightgrid_IBL", "_PBR", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "0" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTGRID_IBL_PBR_RT_CAPTURE, "builtin/lighting/ambient_lightgrid_IBL", "_PBR_RT_capture", { { "USE_GPU_SKINNING", "0" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL ) }, { "RT_REFLECTION_CAPTURE", "1" } }, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL },
		{ BUILTIN_AMBIENT_LIGHTGRID_IBL_PBR_SKINNED, "builtin/lighting/ambient_lightgrid_IBL", "_PBR_skinned", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "0" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },
		{ BUILTIN_AMBIENT_LIGHTGRID_IBL_PBR_SKINNED_RT_CAPTURE, "builtin/lighting/ambient_lightgrid_IBL", "_PBR_skinned_RT_capture", { { "USE_GPU_SKINNING", "1" }, { "USE_PBR", "1" }, { "USE_PUSH_CONSTANTS", usePushConstants( BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED ) }, { "RT_REFLECTION_CAPTURE", "1" } }, true, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED },
...

	{
		...
		renderProgs[builtinShaders[BUILTIN_AMBIENT_LIGHTING_IBL_SKINNED_RT_CAPTURE]].usesJoints = true;
		renderProgs[builtinShaders[BUILTIN_AMBIENT_LIGHTING_IBL_PBR_SKINNED]].usesJoints = true;
		renderProgs[builtinShaders[BUILTIN_AMBIENT_LIGHTING_IBL_PBR_SKINNED_RT_CAPTURE]].usesJoints = true;

		renderProgs[builtinShaders[BUILTIN_AMBIENT_LIGHTGRID_IBL_SKINNED]].usesJoints = true;
		renderProgs[builtinShaders[BUILTIN_AMBIENT_LIGHTGRID_IBL_SKINNED_RT_CAPTURE]].usesJoints = true;
		renderProgs[builtinShaders[BUILTIN_AMBIENT_LIGHTGRID_IBL_PBR_SKINNED]].usesJoints = true;
		renderProgs[builtinShaders[BUILTIN_AMBIENT_LIGHTGRID_IBL_PBR_SKINNED_RT_CAPTURE]].usesJoints = true;
