...
void idRenderBackend::Init()
{
	...
	hiZGenPass = nullptr;
	ssaoPass = nullptr;
	neuralTemporalBackend = ( r_neuralBackend.GetInteger() >= 2 || R_StreamlineIsInitialized() ) ? R_CreateStreamlineNeuralTemporalBackend() : R_CreateNullNeuralTemporalBackend();
