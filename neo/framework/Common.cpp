...
idCVar com_showFPS( "com_showFPS", "1", CVAR_INTEGER | CVAR_SYSTEM | CVAR_ARCHIVE | CVAR_NOCHEAT, "FPS display: 0 off, 1 compact top right, 2 detailed performance statistics" );
// DG end
