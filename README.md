...
The internal installer downloads optional neural components using pinned versions and hashes. It does not bundle proprietary runtimes, and the experimental NR bridge is not an official NVIDIA engine integration. See [component provenance and distribution limits](docs/neural-rendering/THIRD_PARTY_AND_LEGAL.md). Native RTX and HDR need no NR runtime.
